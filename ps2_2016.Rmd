...
The output of your training code, which you should implement in `svm_test.m`, should be the $\alpha$ vector that is the *average* of all the $\alpha$ vectors that your iteration updates. At iteraction $t$ of stochastic gradient descent you should use stepsize $1/\sqrt{t}$.
