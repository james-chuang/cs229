...
I.e., $\theta_{\mathcal{P}}$ takes the same value as the objective functino for all values of $w$ that satisfy the primal constraints, and is positive infinity if the constraints are violated. Hence, the minimization problem
